...
!function (e, t) {
    ...
    var s = {}, l = "tinymce/geom/Rect", c = "tinymce/util/Promise", u = "tinymce/util/Delay", d = "tinymce/Env",
        f = "tinymce/dom/EventUtils", h = "tinymce/dom/Sizzle", p = "tinymce/util/Arr", m = "tinymce/util/Tools",
        g = "tinymce/dom/DomQuery", v = "tinymce/html/Styles", y = "tinymce/dom/TreeWalker", b = "tinymce/dom/Range",
        C = "tinymce/html/Entities", x = "tinymce/dom/StyleSheetLoader", w = "tinymce/dom/DOMUtils",
        N = "tinymce/dom/ScriptLoader", E = "tinymce/AddOnManager", _ = "tinymce/dom/NodeType", S = "tinymce/text/Zwsp",
        k = "tinymce/caret/CaretContainer", T = "tinymce/dom/RangeUtils", R = "tinymce/NodeChange",
        A = "tinymce/html/Node", B = "tinymce/html/Schema", D = "tinymce/html/SaxParser", M = "tinymce/html/DomParser",
        L = "tinymce/html/Writer", P = "tinymce/html/Serializer", H = "tinymce/dom/Serializer",
        O = "tinymce/dom/TridentSelection", I = "tinymce/util/VK", F = "tinymce/dom/ControlSelection",
        z = "tinymce/util/Fun", W = "tinymce/caret/CaretCandidate", V = "tinymce/geom/ClientRect",
        U = "tinymce/text/ExtendingChar", $ = "tinymce/caret/CaretPosition", q = "tinymce/caret/CaretBookmark",
        j = "tinymce/dom/BookmarkManager", Y = "tinymce/dom/Selection", X = "tinymce/dom/ElementUtils",
        K = "tinymce/fmt/Preview", G = "tinymce/fmt/Hooks", J = "tinymce/Formatter", Q = "tinymce/UndoManager",
        Z = "tinymce/EnterKey", ee = "tinymce/ForceBlocks", te = "tinymce/caret/CaretUtils",
        ne = "tinymce/caret/CaretWalker", re = "tinymce/EditorCommands", ie = "tinymce/util/URI",
        oe = "tinymce/util/Class", ae = "tinymce/util/EventDispatcher", se = "tinymce/data/Binding",
        le = "tinymce/util/Observable", ce = "tinymce/data/ObservableObject", ue = "tinymce/ui/Selector",
        de = "tinymce/ui/Collection", fe = "tinymce/ui/DomUtils", he = "tinymce/ui/BoxUtils",
        pe = "tinymce/ui/ClassList", me = "tinymce/ui/ReflowQueue", ge = "tinymce/ui/Control",
        ve = "tinymce/ui/Factory", ye = "tinymce/ui/KeyboardNavigation", be = "tinymce/ui/Container",
        Ce = "tinymce/ui/DragHelper", xe = "tinymce/ui/Scrollable", we = "tinymce/ui/Panel", Ne = "tinymce/ui/Movable",
        Ee = "tinymce/ui/Resizable", _e = "tinymce/ui/FloatPanel", Se = "tinymce/ui/Window",
        ke = "tinymce/ui/MessageBox", Te = "tinymce/WindowManager", Re = "tinymce/ui/Tooltip", Ae = "tinymce/ui/Widget",
        Be = "tinymce/ui/Progress", De = "tinymce/ui/Notification", Me = "tinymce/NotificationManager",
        Le = "tinymce/dom/NodePath", Pe = "tinymce/util/Quirks", He = "tinymce/EditorObservable", Oe = "tinymce/Mode",
        Ie = "tinymce/Shortcuts", Fe = "tinymce/file/Uploader", ze = "tinymce/file/Conversions",
        We = "tinymce/file/ImageScanner", Ve = "tinymce/file/BlobCache", Ue = "tinymce/EditorUpload",
        $e = "tinymce/caret/FakeCaret", qe = "tinymce/dom/Dimensions", je = "tinymce/caret/LineWalker",
        Ye = "tinymce/caret/LineUtils", Xe = "tinymce/DragDropOverrides", Ke = "tinymce/SelectionOverrides",
        Ge = "tinymce/Editor", Je = "tinymce/util/I18n", Qe = "tinymce/FocusManager", Ze = "tinymce/EditorManager",
        et = "tinymce/LegacyInput", tt = "tinymce/util/XHR", nt = "tinymce/util/JSON", rt = "tinymce/util/JSONRequest",
        it = "tinymce/util/JSONP", ot = "tinymce/util/LocalStorage", at = "tinymce/Compat", st = "tinymce/ui/Layout",
        lt = "tinymce/ui/AbsoluteLayout", ct = "tinymce/ui/Button", ut = "tinymce/ui/ButtonGroup",
        dt = "tinymce/ui/Checkbox", ft = "tinymce/ui/ComboBox", ht = "tinymce/ui/ColorBox",
        pt = "tinymce/ui/PanelButton", mt = "tinymce/ui/ColorButton", gt = "tinymce/util/Color",
        vt = "tinymce/ui/ColorPicker", yt = "tinymce/ui/Path", bt = "tinymce/ui/ElementPath",
        Ct = "tinymce/ui/FormItem", xt = "tinymce/ui/Form", wt = "tinymce/ui/FieldSet", Nt = "tinymce/ui/FilePicker",
        Et = "tinymce/ui/FitLayout", _t = "tinymce/ui/FlexLayout", St = "tinymce/ui/FlowLayout",
        kt = "tinymce/ui/FormatControls", Tt = "tinymce/ui/GridLayout", Rt = "tinymce/ui/Iframe",
        At = "tinymce/ui/InfoBox", Bt = "tinymce/ui/Label", Dt = "tinymce/ui/Toolbar", Mt = "tinymce/ui/MenuBar",
        Lt = "tinymce/ui/MenuButton", Pt = "tinymce/ui/MenuItem", Ht = "tinymce/ui/Throbber", Ot = "tinymce/ui/Menu",
        It = "tinymce/ui/ListBox", Ft = "tinymce/ui/Radio", zt = "tinymce/ui/ResizeHandle", Wt = "tinymce/ui/SelectBox",
        Vt = "tinymce/ui/Slider", Ut = "tinymce/ui/Spacer", $t = "tinymce/ui/SplitButton",
        qt = "tinymce/ui/StackLayout", jt = "tinymce/ui/TabPanel", Yt = "tinymce/ui/TextBox", Xt = "tinymce/Register";
    r(l, [], function () {
        function e(e, t, n) {
            var r, i, a, s, l, u;
        ...
        function o(e, n) {
            ...
            if (s.target || (s.target = s.srcElement || document), t.experimentalShadowDom && (s.target = i(e, s.target)), e && c.test(e.type) && e.pageX === l && e.clientX !== l) {
                var d = s.target.ownerDocument || document, f = d.documentElement, h = d.body;
        ...
        function s() {
            function e(e, t) {
                var n, r, o, a, s = i[t];
                if (n = s && s[e.type]) for (r = 0, o = n.length; o > r; r++) if (a = n[r], a && a.func.call(a.scope, e) === !1 && e.preventDefault(), e.isImmediatePropagationStopped()) return
            }

            var t = this, i = {}, s, c, u, d, f;
            c = l + (+new Date).toString(32), d = "onmouseenter" in document.documentElement, u = "onfocusin" in document.documentElement, f = {
                ...
                if (r && 3 !== r.nodeType && 8 !== r.nodeType) {
                    for (r[c] ? g = r[c] : (g = s++, r[c] = g, i[g] = {}), p = p || r, l = l.split(" "), y = l.length; y--;) b = l[y], x = m, C = w = !1, "DOMContentLoaded" === b && (b = "ready"), t.domLoaded && "ready" === b && "complete" == r.readyState ? h.call(p, o({type: b})) : (d || (C = f[b], C && (x = function (t) {
                        var n, r;
                        if (n = t.currentTarget, r = t.relatedTarget, r && n.contains) r = n.contains(r); else for (; r && r !== n;) r = r.parentNode;
                    ...
                    }), v = i[g][b], v ? "ready" === b && t.domLoaded ? h({type: b}) : v.push({
                        func: h,
                        scope: p
                    }) : (i[g][b] = v = [{
                        func: h,
                ...
                if (a = e[c]) {
                    if (f = i[a], n) {
                        for (n = n.split(" "), l = n.length; l--;) if (d = n[l], s = f[d]) {
                            if (o) for (u = s.length; u--;) if (s[u].func === o) {
                                var h = s.nativeHandler, p = s.fakeName, m = s.capture;
                ...
                var n, r, i = t.unbind;
                if (!e || 3 === e.nodeType || 8 === e.nodeType) return t;
                if (e[c] && i(e), e.getElementsByTagName || (e = e.document), e && e.getElementsByTagName) for (i(e), r = e.getElementsByTagName("*"), n = r.length; n--;) e = r[n], e[c] && i(e);
                return t
            }, t.destroy = function () {
                i = {}
            }, t.cancel = function (e) {
        ...
        var l = "mce-data-", c = /^(?:mouse|contextmenu)|click/,
            u = {keyLocation: 1, layerX: 1, layerY: 1, returnValue: 1, webkitMovementX: 1, webkitMovementY: 1};
        return s.Event = new s, s.Event.bind(window, "ready", function () {
        }), s
    }), r(h, [], function () {
        function e(e, t, n, r) {
        ...
        function v(e, t, n, i, o, a) {
            return i && !i[F] && (i = v(i)), o && !o[F] && (o = v(o, a)), r(function (r, a, s, l) {
                var c, u, d, f = [], h = [], p = a.length, v = r || m(t || "*", s.nodeType ? [s] : s, []),
                    y = !e || !r && t ? v : g(v, f, e, s, l), b = n ? o || (r ? e : p || i) ? [] : a : y;
        ...
        function b(t, n) {
            var i = n.length > 0, o = t.length > 0, a = function (r, a, s, l, c) {
                var u, d, f, h = 0, p = "0", m = r && [], v = [], y = T, b = r || o && w.find.TAG("*", c),
                    C = W += null == y ? 1 : Math.random() || .1, x = b.length;
        ...
        var C, x, w, N, E, _, S, k, T, R, A, B, D, M, L, P, H, O, I, F = "sizzle" + -new Date, z = window.document,
            W = 0, V = 0, U = n(), $ = n(), q = n(), j = function (e, t) {
                return e === t && (A = !0), 0
            }, Y = typeof t, X = 1 << 31, K = {}.hasOwnProperty, G = [], J = G.pop, Q = G.push, Z = G.push, ee = G.slice,
            ...
            ue = new RegExp("=" + re + "*([^\\]'\"]*?)" + re + "*\\]", "g"), de = new RegExp(ae),
            fe = new RegExp("^" + ie + "$"), he = {
                ID: new RegExp("^#(" + ie + ")"),
                CLASS: new RegExp("^\\.(" + ie + ")"),
                TAG: new RegExp("^(" + ie + "|[*])"),
            ...
            ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, be = /'|\\/g,
            Ce = new RegExp("\\\\([\\da-f]{1,6}" + re + "?|(" + re + ")|.)", "ig"), xe = function (e, t, n) {
                var r = "0x" + t - 65536;
        ...
        x = e.support = {}, E = e.isXML = function (e) {
            ...
            var n, r = e ? e.ownerDocument || e : z, o = r.defaultView;
            return r !== D && 9 === r.nodeType && r.documentElement ? (D = r, M = r.documentElement, L = !E(r), o && o !== t(o) && (o.addEventListener ? o.addEventListener("unload", function () {
                B()
            ...
            }, H = [], P = [], (x.qsa = ge.test(r.querySelectorAll)) && (i(function (e) {
            ...
            }), P = P.length && new RegExp(P.join("|")), H = H.length && new RegExp(H.join("|")), n = ge.test(M.compareDocumentPosition), I = n || ge.test(M.contains) ? function (e, t) {
            ...
            var r = w.attrHandle[n.toLowerCase()], i = r && K.call(w.attrHandle, n.toLowerCase()) ? r(e, n, !L) : t;
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        var c, u, d, f, h, p, m = o !== a ? "nextSibling" : "previousSibling", g = t.parentNode,
        ...
        var w = document, N = Array.prototype.push, E = Array.prototype.slice,
            _ = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, S = e.Event, k,
            T = r.makeMap("children,contents,next,prev"),
            ...
            B = {"for": "htmlFor", "class": "className", readonly: "readOnly"}, D = {"float": "cssFloat"}, M = {},
            L = {}, P = /^\s*|\s*$/g;
        return f.fn = f.prototype = {
            constructor: f, selector: "", context: null, length: 0, init: function (e, t) {
                ...
                if (a(e)) {
                    ...
                    if (r[1]) for (i = l(e, v(t)).firstChild; i;) N.call(n, i), i = i.nextSibling; else {
                ...
                if (t !== !1) for (r = f.unique(n.toArray().concat(f.makeArray(e))), n.length = r.length, i = 0; i < r.length; i++) n[i] = r[i]; else N.apply(n, f.makeArray(e));
                return n
            }, attr: function (e, t) {
                var n = this, r;
        ...
        function t(n) {
            ...
            function h(e, t) {
                var n = L[V], r = L[W], i = L[U], o = L[$], a = t.startContainer, s = t.startOffset, l = t.endContainer,
                    c = t.endOffset;
            ...
            function R(e, t) {
                var n = C(L[U], L[$] - 1), r, i, o, a, s, l = n != L[U];
            ...
            function A(e, t) {
                var n = C(L[V], L[W]), r = n != L[V], i, o, a, s, l;
            ...
            var L = this, P = n.doc, H = 0, O = 1, I = 2, F = !0, z = !1, W = "startOffset", V = "startContainer",
                U = "endContainer", $ = "endOffset", q = e.extend, j = n.nodeIndex;
            return q(L, {
                startContainer: P,
                startOffset: 0,
                endContainer: P,
        ...
        var r = e.makeMap, i, o, a, s = /[&<>\"\u0060\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
            l = /[<>&\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g, c = /[<>&\"\']/g,
            u = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi, d = {
                128: "\u20ac",
                130: "\u201a",
                131: "\u0192",
                132: "\u201e",
        ...
        return p.prototype = {
            $$: function (e) {
                ...
                return e && this.doc && "string" == typeof e && (t = e,
                    e = this.doc.getElementById(e), e && e.id !== t) ? this.doc.getElementsByName(t)[1] : e
        ...
        return function (e) {
            ...
            function f(e) {
                var n, r, i, o, s, l, c, f, h, p, m, g, v, b, x, w, N, E, _,
                    S = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
                    k = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/, T = /[*?+]/;
                if (e) for (e = t(e, ","), y["@"] && (w = y["@"].attributes, N = y["@"].attributesOrder), n = 0, r = e.length; r > n; n++) if (s = S.exec(e[n])) {
            ...
            function p(e) {
                ...
                e && (i.text_block_elements = i.block_elements = null, s(t(e, ","), function (e) {
                    ...
                    if (b[o] = b[i], L[o] = i, r || (R[o.toUpperCase()] = {},
                        R[o] = {}), !y[o]) {
                        var a = y[i];
            ...
            var v = this, y = {}, b = {}, C = [], x, w, N, E, _, S, k, T, R, A, B, D, M, L = {}, P = {};
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, h = [], p, m, g, v, y, b, C, x, w, N, E, _, S, k, T, R, A, B, D, M, L, P,
                    H, O, I, F = 0, z = t.decode, W, V = n.makeMap("src,href,data,background,formaction,poster"),
                    U = /((java|vb)script|mhtml):/i, $ = /^data:/i;
                for (P = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-_\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), H = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, C = a.getShortEndedElements(), L = i.self_closing_elements || a.getSelfClosingElements(), x = a.getBoolAttrs(), N = i.validate, b = i.remove_internals, W = i.fix_self_closing, O = a.getSpecialElements(); c = P.exec(e);) {
                    if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6]) d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), o(d); else if (d = c[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, W && L[d] && h.length > 0 && h[h.length - 1].name === d && o(d), !N || (E = a.getElementRule(d))) {
                            if (_ = !0, N && (T = E.attributes, R = E.attributePatterns), (k = c[8]) ? (y = -1 !== k.indexOf("data-mce-type"), y && b && (_ = !1), p = [], p.map = {}, k.replace(H, s)) : (p = [], p.map = {}), N && !y) {
                                if (A = E.attributesRequired, B = E.attributesDefault, D = E.attributesForced, M = E.removeEmptyAttrs, M && !p.length && (_ = !1), D) for (m = D.length; m--;) S = D[m], v = S.name, I = S.value, "{$uid}" === I && (I = "mce_" + F++), p.map[v] = I, p.push({
                                    name: v,
                                    value: I
                                });
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate" in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                var v, y, b, C, x, w, N, E, _, S, k, T, R, A = [], B, D, M, L, P, H, O, I;
                if (o = o || {}, h = {}, p = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), H = l.children, k = r.validate, I = "forced_root_block" in o ? o.forced_root_block : r.forced_root_block, P = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, L = /^[ \t\r\n]+$/, v = new n({
                    ...
                    start: function (e, t, n) {
                        ...
                        if (r = k ? l.getElementRule(t) : {}) {
                            if (T[t] && !B) {
                                if (n = b.firstChild, n && 3 === n.type) if (i = n.value.replace(R, ""), i.length > 0) n.value = i, n = n.next; else for (o = n.next, n.remove(), n = o; n && 3 === n.type;) i = n.value, o = n.next, (0 === i.length || L.test(i)) && (n.remove(), n = o), n = o;
                                if (n = b.lastChild, n && 3 === n.type) if (i = n.value.replace(D, ""), i.length > 0) n.value = i, n = n.prev; else for (o = n.prev, n.remove(), n = o; n && 3 === n.type;) i = n.value, o = n.prev, (0 === i.length || L.test(i)) && (n.remove(), n = o), n = o
                            }
    ...
    }), r(H, [w, M, D, C, P, A, B, d, m, S], function (e, t, n, r, i, o, a, s, l, c) {
        function u(e) {
            function t(e) {
                return e && "br" === e.name
            }
        ...
        return function (e, o) {
            ...
            function g() {
                var e = o.getBody().innerHTML, t = /<(\w+) [^>]*data-mce-bogus="all"[^>]*>/g, r, i, a, s, l,
                    c = o.schema;
        ...
        return function (i, a) {
            ...
            function l(t) {
                var n, r, i, o, s;
                n = t.screenX - B, r = t.screenY - D, F = n * R[2] + P, z = r * R[3] + H, F = 5 > F ? 5 : F, z = 5 > z ? 5 : z, i = "IMG" == _.nodeName && a.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == _.nodeName && R[2] * R[3] !== 0, i && ($(n) > $(r) ? (z = q(F * O), F = q(z / O)) : (F = q(z / O), z = q(F * O))), N.setStyles(S, {
                    width: F,
                    height: z
                }), o = R.startPos.x + n, s = R.startPos.y + r, o = o > 0 ? o : 0, s = s > 0 ? s : 0, N.setStyles(k, {
                    left: o,
                    top: s,
                    display: "block"
                }), k.innerHTML = F + " &times; " + z, R[2] < 0 && S.clientWidth <= F && N.setStyle(S, "left", M + (P - F)), R[3] < 0 && S.clientHeight <= z && N.setStyle(S, "top", L + (H - z)), n = j.scrollWidth - Y, r = j.scrollHeight - X, n + r !== 0 && N.setStyles(k, {
                    left: o - n,
                    top: s - r
            ...
            function c() {
                function e(e, t) {
                    t && (_.style[e] || !a.schema.isValid(_.nodeName.toLowerCase(), e) ? N.setStyle(_, e, t) : N.setAttrib(_, e, t))
                }

                I = !1, e("width", F), e("height", z), N.unbind(W, "mousemove", l), N.unbind(W, "mouseup", c), V != W && (N.unbind(V, "mousemove", l), N.unbind(V, "mouseup", c)), N.remove(S), N.remove(k), U && "TABLE" != _.nodeName || u(_), a.fire("ObjectResized", {
                    target: _,
                    width: F,
                    height: z
                }), N.setAttrib(_, "style", N.getAttrib(_, "style")), a.nodeChanged()
            }

            function u(e, t, n) {
                var i, o, u, f, h;
                d(), b(), i = N.getPos(e, j), M = i.x, L = i.y, h = e.getBoundingClientRect(), o = h.width || h.right - h.left, u = h.height || h.bottom - h.top, _ != e && (y(), _ = e, F = z = 0), f = a.fire("ObjectSelected", {target: e}), s(e) && !f.isDefaultPrevented() ? E(T, function (e, i) {
                    function a(t) {
                        B = t.screenX, D = t.screenY, P = _.clientWidth, H = _.clientHeight, O = H / P, R = e, e.startPos = {
                            x: o * e[0] + M,
                            y: u * e[1] + L
                        }, Y = j.scrollWidth, X = j.scrollHeight, S = _.cloneNode(!0), N.addClass(S, "mce-clonedresizable"), N.setAttrib(S, "data-mce-bogus", "all"), S.contentEditable = !1, S.unSelectabe = !0, N.setStyles(S, {
                            left: M,
                            top: L,
                            margin: 0
                        }), S.removeAttribute("data-mce-selected"), j.appendChild(S), N.bind(W, "mousemove", l), N.bind(W, "mouseup", c), V != W && (N.bind(V, "mousemove", l), N.bind(V, "mouseup", c)), k = N.add(j, "div", {
                    ...
                    var s;
                    return t ? void (i == t && a(n)) : (s = N.get("mceResizeHandle" + i), s && N.remove(s), s = N.add(j, "div", {
                        id: "mceResizeHandle" + i,
                        "data-mce-bogus": "all",
                        "class": "mce-resizehandle",
                        unselectable: !0,
                        style: "cursor:" + i + "-resize; margin:0; padding:0"
                    }), r.ie && (s.contentEditable = !1), N.bind(s, "mousedown", function (e) {
                        e.stopImmediatePropagation(), e.preventDefault(), a(e)
                    }), e.elm = s, void N.setStyles(s, {
            ...
            function d() {
                ...
                for (e in T) t = N.get("mceResizeHandle" + e), t && (N.unbind(t), N.remove(t))
            }
            ...
            function f(e) {
                ...
                var n, r;
                if (!I && !a.removed) return E(N.select("img[data-mce-selected],hr[data-mce-selected]"), function (e) {
                    e.removeAttribute("data-mce-selected")
                }), r = "mousedown" == e.type ? e.target : i.getNode(), r = N.$(r).closest(U ? "table" : "table,img,hr")[0], t(r, j) && (C(), n = i.getStart(!0), t(n, r) && t(i.getEnd(!0), r) && (!U || r != n && "IMG" !== n.nodeName)) ? void u(r) : void d()
            }
            ...
            var N = a.dom, E = t.each, _, S, k, T, R, A, B, D, M, L, P, H, O, I, F, z, W = a.getDoc(), V = document,
                U = r.ie && r.ie < 11, $ = Math.abs, q = Math.round, j = a.getBody(), Y, X;
            ...
            return a.contentStyles.push(K + " div.mce-resizehandle {position: absolute;border: 1px solid black;box-sizing: box-sizing;background: #FFF;width: 7px;height: 7px;z-index: 10000}" + K + " .mce-resizehandle:hover {background: #000}" + K + " img[data-mce-selected]," + K + " hr[data-mce-selected] {outline: 1px solid black;resize: none}" + K + " .mce-clonedresizable {position: absolute;" + (r.gecko ? "" : "outline: 1px dashed black;") + "opacity: .5;filter: alpha(opacity=50);z-index: 10000}" + K + " .mce-resize-helper {background: #555;background: rgba(0,0,0,0.75);border-radius: 3px;border: 1px;color: white;display: none;font-family: sans-serif;font-size: 12px;white-space: nowrap;line-height: 14px;margin: 5px 10px;padding: 5px;position: absolute;z-index: 10001}"), a.on("init", function () {
                ...
                a.on("nodechange ResizeEditor ResizeWindow drop", e), a.on("keyup compositionend", function (t) {
        ...
        var l = e.isContentEditableTrue, c = e.isContentEditableFalse, u = e.isBr, d = e.isText,
            f = e.matchNodeNames("script style textarea"),
            h = e.matchNodeNames("img input textarea hr iframe video audio object"), p = e.matchNodeNames("table"),
        ...
        function c(e) {
            ...
            function s(e, t) {
                ...
                if (t < e.data.length) {
                    ...
                    if (a.isExtendingChar(e.data[t - 1]) && (o.setStart(e, t), o.setEnd(e, t + 1), !l(o))) return i(r(n(o), !1)), c
                }
                t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), l(o) || i(r(n(o), !1))), t < e.data.length && (o.setStart(e, t), o.setEnd(e, t + 1), l(o) || i(r(n(o), !0)))
            }
        ...
        var d = t.isElement, f = i.isCaretCandidate, h = t.matchStyleValues("display", "block table"),
            p = t.matchStyleValues("float", "left right"), m = e.and(d, f, e.negate(p)),
            g = e.negate(t.matchStyleValues("white-space", "pre pre-line pre-wrap")), v = t.isText, y = t.isBr,
            b = n.nodeIndex, C = r.getNode;
        ...
        function a(a) {
            ...
            this.getBookmark = function (e, c) {
                ...
                function f(e) {
                    function t(e, t) {
                        var r = e[t ? "startContainer" : "endContainer"], i = e[t ? "startOffset" : "endOffset"],
                            o = [], a, s, u = 0;
                        if (3 == r.nodeType) {
    ...
    }), r(Y, [y, O, F, T, j, _, d, m], function (e, n, r, i, o, a, s, l) {
        function c(e, t, i, a) {
            var s = this;
        ...
        return c.prototype = {
            setCursorLocation: function (e, t) {
                ...
                var t = this, n = t.getRng(), r, i, o, a, s, l = t.dom.getRoot();
            ...
            this.compare = function (n, i) {
                function o(e) {
                    ...
                    return r(t.getAttribs(e), function (r) {
                        ...
                        0 !== i.indexOf("_") && "style" !== i && "data-mce-style" !== i && "data-mce-fragment" != i && (n[i] = t.getAttrib(e, i))
                    }), n
                }
        ...
        return function (s) {
                ...
                function f(e) {
                    ...
                    if (e = O(e, h, re), p.split) {
                        if (t = U(e, re), n = U(e), t != n) {
                            if (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && c(n) && n.firstChild && (n = n.firstChild || n),
                            Y.isChildOf(t, n) && !J(n) && !c(t) && !c(n)) return t = H(t, "span", {
                                id: "_start",
                                "data-mce-type": "bookmark"
                            }), l(t), void (t = u(re));
                            t = H(t, "span", {id: "_start", "data-mce-type": "bookmark"}), n = H(n, "span", {
                                id: "_end",
                                "data-mce-type": "bookmark"
                            }), l(t), l(n), t = u(re), n = u()
                        } else t = n = l(t);
                ...
                function i(e, t, i) {
                    ...
                    if (s) if (s.length === oe) {
                        for (o in s) if (s.hasOwnProperty(o)) {
                            ...
                            if ((!r || t.exact) && !B(a, M(L(s[o], n), o))) return
                        }
            ...
            function F(e, t, n, r) {
                ...
                if ("all" != e.remove) for (ue(e.styles, function (i, o) {
                    i = M(L(i, t), o), "number" == typeof o && (o = i, r = 0), (e.remove_similar || !r || B(D(r, o), i)) && Y.setStyle(n, o, ""), a = 1
                }), a && "" === Y.getAttrib(n, "style") && (n.removeAttribute("style"), n.removeAttribute("data-mce-style")), ue(e.attributes, function (e, i) {
                    var o;
                    if (e = L(e, t), "number" == typeof i && (i = e, r = 0), !r || B(Y.getAttrib(r, i), e)) {
                    ...
                    e = L(e, t), r && !Y.hasClass(r, e) || Y.removeClass(n, e)
            ...
            var j = {}, Y = s.dom, X = s.selection, K = new t(Y), G = s.schema.isValidChild, J = Y.isBlock,
                Q = s.settings.forced_root_block, Z = Y.nodeIndex, ee = "\ufeff", te = /^(src|href|style)$/, ne = !1,
                re = !0, ie, oe, ae = Y.getContentEditable, se, le, ce = n.isBookmarkNode, ue = i.each, de = i.grep,
                fe = i.walk, he = i.extend;
            he(this, {
                get: m,
                register: g,
                unregister: v,
        ...
        return function (i) {
            function o(o) {
                ...
                function C(e) {
                    ...
                    if (e || "TABLE" == z ? (n = a.create(e || V), y(n)) : n = L.cloneNode(!1), o = n, l.keep_styles !== !1) do if (s[t.nodeName]) {
                ...
                if (R = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(R), D = R.startContainer, M = R.startOffset, V = (l.force_p_newlines ? "p" : "") || l.forced_root_block, V = V ? V.toUpperCase() : "", P = a.doc.documentMode, H = o.shiftKey, 1 == D.nodeType && D.hasChildNodes() && (U = M > D.childNodes.length - 1, D = D.childNodes[Math.min(M, D.childNodes.length - 1)] || D, M = U && 3 == D.nodeType ? D.nodeValue.length : 0), B = S(D)) {
                        if (c.beforeChange(), !a.isBlock(B) && B != a.getRoot()) return void (V && !H || E());
                        if ((V && !H || !V && H) && (D = w(D, M)), L = a.getParent(D, a.isBlock), F = L ? a.getParent(L.parentNode, a.isBlock) : null, z = L ? L.nodeName.toUpperCase() : "", W = F ? F.nodeName.toUpperCase() : "", "LI" != W || o.ctrlKey || (L = F, z = W), /^(LI|DT|DD)$/.test(z)) {
                            if (!V && H) return void E();
                            if (a.isEmpty(L)) return void N()
                        }
                        if ("PRE" == z && l.br_in_pre !== !1) {
                            if (!H) return void E()
                        } else if (!V && !H && "LI" != z || V && H) return void E();
                        V && L === i.getBody() || (V = V || "P", x() ? T() : x(!0) ? (O = L.parentNode.insertBefore(C(), L), m(O), v(L)) : (A = R.cloneRange(), A.setEndAfter(L), I = A.extractContents(), _(I), O = I.firstChild, a.insertAfter(I, L), g(O), k(L), a.isEmpty(L) && b(L), O.normalize(), a.isEmpty(O) ? (a.remove(O), T()) : v(O)), a.setAttrib(O, "id", ""), i.fire("NewBlock", {newBlock: O}), c.add())
                    }
                }
            }

            var a = i.dom, s = i.selection, l = i.settings, c = i.undoManager, u = i.schema,
                d = u.getNonEmptyElements(), f = u.getMoveCaretBeforeOnEnterElements();
        ...
        function v(e, t, r) {
            var o, a, s, l, c = N(g, !0, t), u = N(g, !1, t);
        ...
        var b = n.isContentEditableTrue, C = n.isContentEditableFalse,
            x = n.matchStyleValues("display", "block table table-cell table-caption"), w = i.isCaretContainer,
            N = e.curry, E = n.isElement, _ = o.isCaretCandidate, S = N(p, !0), k = N(p, !1);
        return {
            isForwards: a,
            isBackwards: s,
            findNode: l,
        ...
        var d = e.isContentEditableFalse, f = e.isText, h = e.isElement, p = e.isBr, m = r.isForwards,
            g = r.isBackwards, v = t.isCaretCandidate, y = t.isAtomic, b = t.isEditableCaretCandidate;
        return function (e) {
            return {
                next: function (t) {
                    return u(1, t, e)
    ...
    }), r(re, [P, d, m, X, T, y, ne, $, _], function (e, n, r, i, o, a, s, l, c) {
        var u = r.each, d = r.extend, f = r.map, h = r.inArray, p = r.explode, m = n.ie, g = n.ie && n.ie < 11, v = !0,
            y = !1, b = c.matchNodeNames("td th");
        return function (c) {
            function C(e, t, n, r) {
                var i, o, a = 0;
                if (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(e) || r && r.skip_focus || c.focus(), r = c.fire("BeforeExecCommand", {
                    command: e,
                    ui: t,
                    value: n
                }), r.isDefaultPrevented()) return !1;
                if (o = e.toLowerCase(), i = O.exec[o]) return i(o, t, n), c.fire("ExecCommand", {
                    command: e,
                    ui: t,
                    value: n
                }), !0;
                if (u(c.plugins, function (r) {
                    return r.execCommand && r.execCommand(e, t, n) ? (c.fire("ExecCommand", {
                        command: e,
                        ui: t,
                        value: n
                    }), a = !0, !1) : void 0
                }), a) return a;
                if (c.theme && c.theme.execCommand && c.theme.execCommand(e, t, n)) return c.fire("ExecCommand", {
                    command: e,
                    ui: t,
                    value: n
                }), !0;
                try {
                    a = c.getDoc().execCommand(e, t, n)
                } catch (s) {
                }
                return a ? (c.fire("ExecCommand", {command: e, ui: t, value: n}), !0) : !1
            }

            function x(e) {
                var t;
                if (!c.quirks.isHidden()) {
                    if (e = e.toLowerCase(), t = O.state[e]) return t(e);
                    try {
                        return c.getDoc().queryCommandState(e)
                    } catch (n) {
                    }
                    return !1
                }
            ...
            function w(e) {
                var t;
                if (!c.quirks.isHidden()) {
                    if (e = e.toLowerCase(), t = O.value[e]) return t(e);
                    try {
                        return c.getDoc().queryCommandValue(e)
                    } catch (n) {
                    }
                }
            }
            ...
            function E(e, t, n) {
                e = e.toLowerCase(), O.exec[e] = function (e, r, i, o) {
                    return t.call(n || c, r, i, o)
                }
            }

            function _(e) {
                if (e = e.toLowerCase(), O.exec[e]) return !0;
                try {
                    return c.getDoc().queryCommandSupported(e)
                } catch (t) {
                }
                return !1
            }
            ...
            function S(e, t, n) {
                e = e.toLowerCase(), O.state[e] = function () {
                    return t.call(n || c)
                }
            }

            function k(e, t, n) {
                e = e.toLowerCase(), O.value[e] = function () {
                    return t.call(n || c)
                }
            }

            function T(e) {
                return e = e.toLowerCase(), !!O.exec[e]
            }

            function R(e, n, r) {
                return n === t && (n = y), r === t && (r = null), c.getDoc().execCommand(e, n, r)
            }
            ...
            function B(e, n) {
                H.toggle(e, n ? {value: n} : t), c.nodeChanged()
            }
            ...
            var L, P, H, O = {state: {}, exec: {}, value: {}}, I = c.settings, F;
            c.on("PreInit", function () {
                L = c.dom, P = c.selection, I = c.settings, H = c.formatter
            }), d(this, {
                execCommand: C,
                queryCommandState: x,
                queryCommandValue: w,
                ...
                addCommands: N,
                addCommand: E,
                addQueryStateHandler: S,
                addQueryValueHandler: k,
                hasCustomCommand: T
            }), N({
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    if ("paste" !== e || t.queryCommandEnabled(e) || (r = !0), r || !t.queryCommandSupported(e)) {
                        var o = c.translate("Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.");
                        n.mac && (o = o.replace(/Ctrl\+/g, "\u2318+")), c.notificationManager.open({
                            text: o,
                            type: "error"
                        })
                    }
                    ...
                    if (P.isCollapsed()) {
                        var e = P.getNode();
                        return void ("A" == e.tagName && c.dom.remove(e, !0))
                    }
                    H.remove("link")
                    ...
                    "full" == t && (t = "justify"), u("left,center,right,justify".split(","), function (e) {
                        t != e && H.remove("align" + e)
                    }), "none" != t && B("align" + t)
                }, "InsertUnorderedList,InsertOrderedList": function (e) {
                    var t, n;
                    R(e), t = L.getParent(P.getNode(), "ol,ul"), t && (n = t.parentNode, /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (D(), L.split(n, t), M()))
                    ...
                    var r, i;
                    n >= 1 && 7 >= n && (i = p(I.font_size_style_values), r = p(I.font_size_classes), n = r ? r[n - 1] || n : i[n - 1] || n), B(e, n)
                    ...
                    var e = P.getBookmark();
                    c.setContent(c.getContent({cleanup: v}), {cleanup: v}), P.moveToBookmark(e)
                }, mceRemoveNode: function (e, t, n) {
                    var r = n || P.getNode();
                    r != c.getBody() && (D(), c.dom.remove(r, v), M())
                }, mceSelectNodeDepth: function (e, t, n) {
                    var r = 0;
                    L.getParent(P.getNode(), function (e) {
                        return 1 == e.nodeType && r++ == n ? (P.select(e), y) : void 0
                    }, c.getBody())
                    ...
                    function a(e) {
                        ...
                        var n, r, i;
                        return n = P.getRng(!0), r = n.startContainer, i = n.startOffset, 3 == r.nodeType && (i > 0 ? e = e.replace(/^&nbsp;/, " ") : t("previousSibling") || (e = e.replace(/^ /, "&nbsp;")), i < r.length ? e = e.replace(/&nbsp;(<br>|)$/, " ") : t("nextSibling") || (e = e.replace(/(&nbsp;| )(<br>|)$/, "&nbsp;"))), e
                    }

                    function d() {
                        var e, t, n;
                        e = P.getRng(!0), t = e.startContainer, n = e.startOffset, 3 == t.nodeType && e.collapsed && ("\xa0" === t.data[n] ? (t.deleteData(n, 1), /[\u00a0| ]$/.test(o) || (o += " ")) : "\xa0" === t.data[n - 1] && (t.deleteData(n - 1, 1), /[\u00a0| ]$/.test(o) || (o = " " + o)))
                    }

                    function f(e) {
                        if (D) for (R = e.firstChild; R; R = R.walk(!0)) H[R.name] && R.attr("data-mce-new", "true")
                    }

                    function h() {
                        if (D) {
                            var e = c.getBody(), t = new i(L);
                    ...
                    function g(e) {
                        r.each(e.getElementsByTagName("*"), function (e) {
                    ...
                    function y(e) {
                        return e && !c.schema.getShortEndedElements()[e.nodeName]
                    }

                    function C(e) {
                        function t(e) {
                            for (var t = c.getBody(); e && e !== t; e = e.parentNode) if ("false" === c.dom.getContentEditable(e)) return e;
                            return null
                        }

                        function n(e) {
                            var t = l.fromRangeStart(e), n = new s(c.getBody());
                            return t = n.next(t), t ? t.toRange() : void 0
                        }

                        var r, i, o;
                        if (e) {
                            if (P.scrollIntoView(e), r = t(e)) return L.remove(e), void P.select(r);
                            T = L.createRng(), R = e.previousSibling, R && 3 == R.nodeType ? (T.setStart(R, R.nodeValue.length), m || (A = e.nextSibling, A && 3 == A.nodeType && (R.appendData(A.data), A.parentNode.removeChild(A)))) : (T.setStartBefore(e), T.setEndBefore(e)), i = L.getParent(e, L.isBlock), L.remove(e), i && L.isEmpty(i) && (c.$(i).empty(), T.setStart(i, 0), T.setEnd(i, 0), b(i) || v(i) || !(o = n(T)) ? L.add(i, L.create("br", {"data-mce-bogus": "1"})) : (T = o, L.remove(i))), P.setRng(T)
                        }
                    }

                    var x, w, N, E, _, S, k, T, R, A, B, D, M, H = c.schema.getTextInlineElements();
                    "string" != typeof o && (D = o.merge, M = o.data, o = o.content), /^ | $/.test(o) && (o = a(o)), x = c.parser, w = new e({validate: I.validate}, c.schema), B = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', S = {
                        content: o,
                        format: "html",
                        selection: !0
                    }, c.fire("BeforeSetContent", S), o = S.content, -1 == o.indexOf("{$caret}") && (o += "{$caret}"), o = o.replace(/\{\$caret\}/, B), T = P.getRng();
                    var O = T.startContainer || (T.parentElement ? T.parentElement() : null), F = c.getBody();
                    O === F && P.isCollapsed() && L.isBlock(F.firstChild) && y(F.firstChild) && L.isEmpty(F.firstChild) && (T = L.createRng(), T.setStart(F.firstChild, 0), T.setEnd(F.firstChild, 0), P.setRng(T)), P.isCollapsed() || (c.selection.setRng(c.selection.getRng()), c.getDoc().execCommand("Delete", !1, null), d()), N = P.getNode();
                    var z = {context: N.nodeName.toLowerCase(), data: M};
                    if (_ = x.parse(o, z), p(_), f(_), R = _.lastChild, "mce_marker" == R.attr("id")) for (k = R, R = R.prev; R; R = R.walk(!0)) if (3 == R.type || !L.isBlock(R.name)) {
                        c.schema.isValidChild(R.parent.name, "span") && R.parent.insert(k, R, "br" === R.name);
                        break
                    }
                    if (c._selectionOverrides.showBlockCaretContainer(N), z.invalid) {
                        for (P.setContent(B), N = P.getNode(), E = c.getBody(), 9 == N.nodeType ? N = R = E : R = N; R !== E;) N = R, R = R.parentNode;
                        o = N == E ? E.innerHTML : L.getOuterHTML(N), o = w.serialize(x.parse(o.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function () {
                            return w.serialize(_)
                        }))), N == E ? L.setHTML(E, o) : L.setOuterHTML(N, o)
                    } else o = w.serialize(_), R = N.firstChild, A = N.lastChild, !R || R === A && "BR" === R.nodeName ? L.setHTML(N, o) : P.setContent(o);
                    h(), C(L.get("mce_marker")), g(c.getBody()), c.fire("SetContent", S), c.addVisual()
                }, mceInsertRawHTML: function (e, t, n) {
                    P.setContent("tiny_mce_marker"), c.setContent(c.getContent().replace(/tiny_mce_marker/g, function () {
                        return n
                    }))
                    ...
                    var t, n, r;
                    t = I.indentation, n = /[a-z%]+$/i.exec(t), t = parseInt(t, 10), x("InsertUnorderedList") || x("InsertOrderedList") ? R(e) : (I.forced_root_block || L.getParent(P.getNode(), L.isBlock) || H.apply("div"), u(P.getSelectedBlocks(), function (i) {
                        if ("false" !== L.getContentEditable(i) && "LI" != i.nodeName) {
                            var o = c.getParam("indent_use_margin", !1) ? "margin" : "padding";
                            o += "rtl" == L.getStyle(i, "direction", !0) ? "Right" : "Left", "outdent" == e ? (r = Math.max(0, parseInt(i.style[o] || 0, 10) - t), L.setStyle(i, o, r ? r + n : "")) : (r = parseInt(i.style[o] || 0, 10) + t + n, L.setStyle(i, o, r))
                        }
                    }))
                }, mceRepaint: function () {
                }, InsertHorizontalRule: function () {
                    c.execCommand("mceInsertContent", !1, "<hr />")
                }, mceToggleVisualAid: function () {
                    c.hasVisual = !c.hasVisual, c.addVisual()
                }, mceReplaceContent: function (e, t, n) {
                    c.execCommand("mceInsertContent", !1, n.replace(/\{\$selection\}/g, P.getContent({format: "text"})))
                }, mceInsertLink: function (e, t, n) {
                    var r;
                    "string" == typeof n && (n = {href: n}), r = L.getParent(P.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || H.remove("link"), n.href && H.apply("link", n, r)
                }, selectAll: function () {
                    var e = L.getRoot(), t;
                    P.getRng().setStart ? (t = L.createRng(), t.setStart(e, 0), t.setEnd(e, e.childNodes.length), P.setRng(t)) : (t = P.getRng(), t.item || (t.moveToElementText(e), t.select()))
                }, "delete": function () {
                    R("Delete");
                    var e = c.getBody();
                    L.isEmpty(e) && (c.setContent(""), e.firstChild && L.isBlock(e.firstChild) ? c.selection.setCursorLocation(e.firstChild, 0) : c.selection.setCursorLocation(e, 0))
                }, mceNewDocument: function () {
                    c.setContent("")
                }, InsertLineBreak: function (e, t, n) {
                    function r() {
                        for (var e = new a(h, m), t, n = c.schema.getNonEmptyElements(); t = e.next();) if (n[t.nodeName.toLowerCase()] || t.length > 0) return !0
                    }

                    var i = n, s, l, u, d = P.getRng(!0);
                    new o(L).normalize(d);
                    ...
                    var m = L.getParent(h, L.isBlock), y = m ? m.nodeName.toUpperCase() : "",
                        b = m ? L.getParent(m.parentNode, L.isBlock) : null, C = b ? b.nodeName.toUpperCase() : "",
                        x = i && i.ctrlKey;
                    "LI" != C || x || (m = b, y = C), h && 3 == h.nodeType && f >= h.nodeValue.length && (g || r() || (s = L.create("br"), d.insertNode(s), d.setStartAfter(s), d.setEndAfter(s), l = !0)), s = L.create("br"), d.insertNode(s);
                    var w = L.doc.documentMode;
                    return g && "PRE" == y && (!w || 8 > w) && s.parentNode.insertBefore(L.doc.createTextNode("\r"), s), u = L.create("span", {}, "&nbsp;"), s.parentNode.insertBefore(u, s), P.scrollIntoView(u), L.remove(u), l ? (d.setStartBefore(s), d.setEndBefore(s)) : (d.setStartAfter(s), d.setEndAfter(s)), P.setRng(d), c.undoManager.add(), v
                }
            }), N({
                "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function (e) {
                    var t = "align" + e.substring(7),
                        n = P.isCollapsed() ? [L.getParent(P.getNode(), L.isBlock)] : P.getSelectedBlocks(),
                        r = f(n, function (e) {
                            return !!H.matchNode(e, t)
                        });
                    return -1 !== h(r, v)
                }, "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": function (e) {
                    return A(e)
                    ...
                    var e;
                    if (I.inline_styles) {
                        if ((e = L.getParent(P.getStart(), L.isBlock)) && parseInt(e.style.paddingLeft, 10) > 0) return v;
                        if ((e = L.getParent(P.getEnd(), L.isBlock)) && parseInt(e.style.paddingLeft, 10) > 0) return v
                    }
                    return x("InsertUnorderedList") || x("InsertOrderedList") || !I.inline_styles && !!L.getParent(P.getNode(), "BLOCKQUOTE")
                }, "InsertUnorderedList,InsertOrderedList": function (e) {
                    var t = L.getParent(P.getNode(), "ul,ol");
                    return t && ("insertunorderedlist" === e && "UL" === t.tagName || "insertorderedlist" === e && "OL" === t.tagName)
                }
            }, "state"), N({
                "FontSize,FontName": function (e) {
                    var t = 0, n;
                    return (n = L.getParent(P.getNode(), "span")) && (t = "fontsize" == e ? n.style.fontSize : n.style.fontFamily.replace(/, /g, ",").replace(/[\'\"]/g, "").toLowerCase()), t
                }
            }, "value"), N({
                Undo: function () {
                    c.undoManager.undo()
        ...
        var n = e.each, r = e.trim,
            ...
            o = {ftp: 21, http: 80, https: 443, mailto: 25};
        return t.prototype = {
            setPath: function (e) {
                var t = this;
        ...
        return {
            id: function () {
                ...
                return t.DOM.setAttribs(o, r), "string" == typeof i ? o.innerHTML = i : e.each(i, function (e) {
        ...
        var f = "onmousewheel" in document, h = !1, p = "mce-", m, g = 0, v = {
            Statics: {classPrefix: p}, isRtl: function () {
                return m.rtl
            }, classPrefix: p, init: function (e) {
                function n(e) {
                    var t;
    ...
    }), r(_e, [we, Ne, Ee, fe, g, u], function (e, t, n, r, i, o) {
        function a(e, t) {
            for (; e;) {
                if (e == t) return !0;
                e = e.parent()
    ...
    }), r(De, [ge, Ne, Be, u], function (e, t, n, r) {
        return e.extend({
    ...
    }), r(Pe, [I, T, y, Le, A, C, d, m, u, k], function (e, t, n, r, i, o, a, s, l, c) {
        return function (u) {
            function d(e, t) {
                try {
            ...
            function p(e) {
                var t, n;
                e.dataTransfer && (u.selection.isCollapsed() && "IMG" == e.target.tagName && ee.select(e.target), t = u.selection.getContent(), t.length > 0 && (n = se + escape(u.id) + "," + escape(t), e.dataTransfer.setData(le, n)))
            }

            function m(e) {
                var t;
                return e.dataTransfer && (t = e.dataTransfer.getData(le), t && t.indexOf(se) >= 0) ? (t = t.substr(se.length).split(","), {
                    id: unescape(t[0]),
                    html: unescape(t[1])
                }) : null
            }
            ...
            function v() {
                ...
                function o(e, t) {
                    var n;
                    for (n = e.nextSibling; n && n != t; n = n.nextSibling) if ((3 != n.nodeType || 0 !== G.trim(n.data).length) && n !== t) return !1;
                    return n === t
                }
                ...
                function v(e, t) {
                    function n(e, n) {
                        return m = G(n).parents().filter(function (e, t) {
                ...
                w || (N = !0, w = function () {
                    ...
                    var t = e.keyCode == Q, n = e.ctrlKey || e.metaKey;
                    if (!h(e) && (t || e.keyCode == J)) {
                    ...
                    if (!h(t) && !x.isCollapsed() && t.charCode > 31 && !e.metaKeyPressed(t)) {
                        var n, r, i, o, a, s;
                        n = u.selection.getRng(), s = String.fromCharCode(t.charCode), t.preventDefault(), r = G(n.startContainer).parents().filter(function (e, t) {
                            return !!u.schema.getTextInlineElements()[t.nodeName]
                        }), y(!0), r = r.filter(function (e, t) {
                            return !G.contains(u.getBody(), t)
                        ...
                        }), a.appendChild(u.getDoc().createTextNode(s)), o = C.getParent(n.startContainer, C.isBlock), C.isEmpty(o) ? G(o).empty().append(i) : n.insertNode(i), n.setStart(a.firstChild, 1), n.setEnd(a.firstChild, 1), u.selection.setRng(n)) : u.selection.setContent(s)
                    }
                }), u.addCommand("Delete", function () {
                    y()
                }), u.addCommand("ForwardDelete", function () {
                    y(!0)
                }), N || (u.on("dragstart", function (e) {
                    E = x.getRng(), p(e)
                    ...
                    if (!h(e)) {
                        ...
                        n && (e.preventDefault(), l.setEditorTimeout(u, function () {
                            ...
                            E && (x.setRng(E), E = null), y(), x.setRng(r), g(n.html)
                        }))
                    }
                }), u.on("cut", function (e) {
            ...
            function y() {
                function e(e) {
                    ...
                    return t.appendChild(n), ee.serializer.serialize(t, {format: "html"})
                }
                ...
                u.on("keydown", function (e) {
                    var t = e.keyCode, r, i;
                    if (!h(e) && (t == Q || t == J)) {
                        if (r = u.selection.isCollapsed(), i = u.getBody(), r && !Z.isEmpty(i)) return;
                        if (!r && !n(u.selection.getRng())) return;
                        e.preventDefault(), u.setContent(""), i.firstChild && Z.isBlock(i.firstChild) ? u.selection.setCursorLocation(i.firstChild, 0) : u.selection.setCursorLocation(i, 0), u.nodeChanged()
                    }
                })
            }
            ...
            function C() {
                u.settings.content_editable || Z.bind(u.getDoc(), "mousedown mouseup", function (e) {
                    var t;
                    if (e.target == u.getDoc().documentElement) if (t = ee.getRng(), u.getBody().focus(), "mousedown" == e.type) {
                        if (c.isCaretContainer(t.startContainer)) return;
                        ee.placeCaretAt(e.clientX, e.clientY)
                    } else ee.setRng(t)
                })
            }
            ...
            function x() {
                u.on("keydown", function (e) {
                    if (!h(e) && e.keyCode === J) {
                        ...
                        if (ee.isCollapsed() && 0 === ee.getRng(!0).startOffset) {
                            var t = ee.getNode(), n = t.previousSibling;
                            if ("HR" == t.nodeName) return Z.remove(t), void e.preventDefault();
            ...
            function N() {
                u.on("click", function (e) {
                    var t = e.target;
                    /^(IMG|HR)$/.test(t.nodeName) && "false" !== Z.getContentEditableParent(t) && (e.preventDefault(), ee.getSel().setBaseAndExtent(t, 0, t, 1), u.nodeChanged()), "A" == t.nodeName && Z.hasClass(t, "mce-item-anchor") && (e.preventDefault(), ee.select(t))
                })
            }

            function E() {
                function e() {
                    var e = Z.getAttribs(ee.getStart().cloneNode(!1));
                    return function () {
                        var t = ee.getStart();
                        t !== u.getBody() && (Z.setAttrib(t, "style", null), K(e, function (e) {
                ...
                function t() {
                    return !ee.isCollapsed() && Z.getParent(ee.getStart(), Z.isBlock) != Z.getParent(ee.getEnd(), Z.isBlock)
                }
                ...
                }), Z.bind(u.getDoc(), "cut", function (n) {
                    var r;
            ...
            function S() {
                u.on("keydown", function (e) {
                    if (!h(e) && e.keyCode === J && ee.isCollapsed() && 0 === ee.getRng(!0).startOffset) {
                        var t = ee.getNode().previousSibling;
            ...
            function k() {
                f() > 7 || (d("RespectVisibilityInDesign", !0), u.contentStyles.push(".mceHideBrInPre pre br {display: none}"), Z.addClass(u.getBody(), "mceHideBrInPre"), ne.addNodeFilter("pre", function (e) {
                    for (var t = e.length, n, r, o, a; t--;) for (n = e[t].getAll("br"), r = n.length; r--;) o = n[r], a = o.prev, a && 3 === a.type && "\n" != a.value.charAt(a.value - 1) ? a.value += "\n" : o.parent.insert(new i("#text", 3), o, !0).value = "\n"
                }), re.addNodeFilter("pre", function (e) {
                    for (var t = e.length, n, r, i, o; t--;) for (n = e[t].getAll("br"), r = n.length; r--;) i = n[r], o = i.prev, o && 3 == o.type && (o.value = o.value.replace(/\r?\n$/, ""))
                }))
            }

            function T() {
                Z.bind(u.getBody(), "mouseup", function () {
                    var e, t = ee.getNode();
            ...
            function R() {
                u.on("keydown", function (t) {
                    var n, r, i, o, a;
                    if (!h(t) && t.keyCode == e.BACKSPACE && (n = ee.getRng(), r = n.startContainer, i = n.startOffset, o = Z.getRoot(), a = r, n.collapsed && 0 === i)) {
                        for (; a && a.parentNode && a.parentNode.firstChild == a && a.parentNode != o;) a = a.parentNode;
                        "BLOCKQUOTE" === a.tagName && (u.formatter.toggle("blockquote", null, a), n = Z.createRng(), n.setStart(r, 0), n.setEnd(r, 0), ee.setRng(n))
                    }
                })
            }
            ...
            function A() {
                function e() {
                    Y(), d("StyleWithCSS", !1), d("enableInlineTableEditing", !1), te.object_resizing || d("enableObjectResizing", !1)
                }

                te.readonly || u.on("BeforeExecCommand MouseDown", e)
            }

            function B() {
                function e() {
                    K(Z.select("a"), function (e) {
            ...
            function D() {
                te.forced_root_block && u.on("init", function () {
                    d("DefaultParagraphSeparator", te.forced_root_block)
                })
            }
            ...
            function M() {
                u.on("keydown", function (e) {
                    var t;
                    h(e) || e.keyCode != J || (t = u.getDoc().selection.createRange(), t && t.item && (e.preventDefault(), u.undoManager.beforeChange(), Z.remove(t.item(0)), u.undoManager.add()))
                })
            }

            function L() {
                var e;
                f() >= 10 && (e = "", K("p div h1 h2 h3 h4 h5 h6".split(" "), function (t, n) {
                    e += (n > 0 ? "," : "") + t + ":empty"
                }), u.contentStyles.push(e + "{padding-right: 1px !important}"))
            }

            function P() {
                f() < 9 && (ne.addNodeFilter("noscript", function (e) {
                    for (var t = e.length, n, r; t--;) n = e[t], r = n.firstChild, r && n.attr("data-mce-innertext", r.value)
                }), re.addNodeFilter("noscript", function (e) {
            ...
            function H() {
                ...
                r.documentElement.unselectable = !0, Z.bind(r, "mousedown contextmenu", function (i) {
                    if ("HTML" === i.target.nodeName) {
                        ...
                        o = 1, a = e(i.x, i.y), a && (Z.bind(r, "mouseup", n), Z.bind(r, "mousemove", t), Z.getRoot().focus(), a.select())
                    }
                })
            }
            ...
            function O() {
                u.on("keyup focusin mouseup", function (t) {
                    65 == t.keyCode && e.metaKeyPressed(t) || ee.normalize()
                }, !0)
            }
            ...
            function q() {
                ne.addNodeFilter("br", function (e) {
            ...
            function Y() {
                var e, t;
                X() && (e = u.getBody(), t = e.parentNode, t.removeChild(e), t.appendChild(e), e.focus())
            }

            function X() {
                var e;
                return ie ? (e = u.selection.getSel(), !e || !e.rangeCount || 0 === e.rangeCount) : 0
            }

            var K = s.each, G = u.$, J = e.BACKSPACE, Q = e.DELETE, Z = u.dom, ee = u.selection, te = u.settings,
                ne = u.parser, re = u.serializer, ie = a.gecko, oe = a.ie, ae = a.webkit,
                se = "data:text/mce-internal,", le = oe ? "Text" : "URL";
            return R(), y(), a.windowsPhone || O(), ae && (v(), C(), N(), D(), $(), S(), q(), a.iOS ? (F(), z(), U()) : b()), oe && a.ie < 11 && (x(), _(), k(), T(), M(), L(), P(), H()), a.ie >= 11 && (z(), S()), a.ie && (b(), V(), j()), ie && (x(), w(), E(), A(), B(), I(), W(), S()), {
                refreshContentEditable: Y,
                isHidden: X
            }
        }
        ...
        return function (a) {
            ...
            function l(t, n, i, o) {
                ...
                return l = e.map(r(t, ">"), s), l[l.length - 1] = e.extend(l[l.length - 1], {
                    func: i,
                    scope: o || a
                }), e.extend(l[0], {desc: a.translate(n), subpatterns: l.slice(1)})
            }
            ...
            function d(e, t) {
                return t ? t.ctrl != e.ctrlKey || t.meta != e.metaKey ? !1 : t.alt != e.altKey || t.shift != e.shiftKey ? !1 : e.keyCode == t.keyCode || e.charCode && e.charCode == t.charCode ? (e.preventDefault(), !0) : !1 : !1
            }
            ...
            a.on("keyup keypress keydown", function (e) {
                !c(e) && !u(e) || e.isDefaultPrevented() || (n(p, function (t) {
                    return d(e, t) ? (m = t.subpatterns.slice(0), "keydown" == e.type && f(t), !0) : void 0
                ...
                var t = l(e);
                return p[t.id] ? (delete p[t.id], !0) : !1
            }
        }
    ...
    }), r(We, [c, p, z, ze, d], function (e, t, n, r, i) {
        var o = 0;
        return function (a) {
            function s(s, c) {
                function u(e, t) {
        ...
        return {init: r}
    }), r(Ke, [d, ne, $, k, te, $e, je, Ye, _, T, V, I, z, p, u, Xe, S], function (e, t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g) {
        function v(e, t) {
        ...
        function y(c) {
            ...
            function R(e, t, n) {
                ...
                return r = c.fire("ShowCaret", {
                    ...
                    direction: e,
                    before: n
                }), r.isDefaultPrevented() ? null : (T(t, -1 === e), re.show(n, t))
            }

            function A(e) {
                var t;
                return re.hide(), t = c.fire("BeforeObjectSelected", {target: e}), t.isDefaultPrevented() ? null : B(e)
            }
            ...
            function M(e, t) {
                return t = i.normalizeRange(e, Z, t), -1 == e ? n.fromRangeStart(t) : n.fromRangeEnd(t)
            }
            ...
            function P(e, t, n, r) {
                var i, o, a, s;
                return !r.collapsed && (i = _(r), x(i)) ? R(e, i, -1 == e) : (s = L(r), o = M(e, r), n(o) ? A(o.getNode(-1 == e)) : (o = t(o)) ? n(o) ? R(e, o.getNode(-1 == e), 1 == e) : (a = t(o), n(a) && D(o, a) ? R(e, a.getNode(-1 == e), 1 == e) : s ? U(o.toRange()) : null) : s ? r : null)
            }

            function H(e, t, n) {
                var r, i, o, l, c, u, d, f, p;
                if (p = _(n), r = M(e, n), i = t(Z, a.isAboveLine(1), r), o = h.filter(i, a.isLine(1)), c = h.last(r.getClientRects()), E(r) && (p = r.getNode()), N(r) && (p = r.getNode(!0)), !c) return null;
                if (u = c.left, l = s.findClosestClientRect(o, u), l && x(l.node)) return d = Math.abs(u - l.left), f = Math.abs(u - l.right), R(e, l.node, f > d);
                if (p) {
                    var m = a.positionsUntil(e, Z, a.isAboveLine(1), p);
            ...
            function O(t, r) {
                ...
                if (r.collapsed && c.settings.forced_root_block) {
                    ...
                    a = 1 == t ? te(n.fromRangeStart(r)) : ne(n.fromRangeStart(r)), a || (s = i(), 1 == t ? c.$(o).after(s) : c.$(o).before(s), c.selection.select(s, !0), c.selection.collapse())
                }
            }
            ...
            function z() {
                return ae("*[data-mce-caret]")[0]
            }

            function W(e) {
                e = ae(e), e.attr("data-mce-caret") && (re.hide(), e.removeAttr("data-mce-caret"), e.removeAttr("data-mce-bogus"), e.removeAttr("style"), S(k()), T(e[0]))
            }

            function V(e) {
                var t, r;
                return e = i.normalizeRange(1, Z, e), t = n.fromRangeStart(e), x(t.getNode()) ? R(1, t.getNode(), !t.isAtEnd()) : x(t.getNode(!0)) ? R(1, t.getNode(!0), !1) : (r = c.dom.getParent(t.getNode(), f.or(x, C)), x(r) ? R(1, r, !1) : (re.hide(), null))
            }
            ...
            function $(e) {
                var t, i, o, a;
                return x(e) ? (x(e.previousSibling) && (o = e.previousSibling), i = ne(n.before(e)), i || (t = te(n.after(e))), t && w(t.getNode()) && (a = t.getNode()), r.remove(e.previousSibling), r.remove(e.nextSibling), c.dom.remove(e), J(), c.dom.isEmpty(c.getBody()) ? (c.setContent(""), void c.focus()) : o ? n.after(o).toRange() : a ? n.before(a).toRange() : i ? i.toRange() : t ? t.toRange() : null) : null
            }

            function q(e, t, n) {
                var r = c.dom, i, o, a, s;
                if (-1 === e) {
                    if (N(n) && y(n.getNode(!0))) return $(n.getNode(!0))
                } else if (E(t) && y(t.getNode())) return $(t.getNode());
                if (s = c.schema.getTextBlockElements(), i = r.getParent(t.getNode(), r.isBlock), o = r.getParent(n.getNode(), r.isBlock), i === o || !s[i.nodeName] || !s[o.nodeName]) return null;
                for (; a = i.firstChild;) o.appendChild(a);
                return c.dom.remove(i), n.toRange()
            }

            function j(e, t, n) {
                var r, i, o;
                return !n.collapsed && (r = _(n), x(r)) ? U($(r)) : (i = M(e, n), t(i) ? U($(i.getNode(-1 == e))) : (o = -1 == e ? ee.prev(i) : ee.next(i), t(o) ? -1 === e ? q(e, i, o) : q(e, o, i) : void 0))
            }
            ...
            function Y() {
                ...
                var f = b(I, 1, te, E), g = b(I, -1, ne, N), v = b(j, 1, E), w = b(j, -1, N), _ = b(F, -1, a.upUntil),
                    T = b(F, 1, a.downUntil);
                c.on("mouseup", function () {
                    ...
                    var n;
                    n = t(e.target), n && x(n) && e.preventDefault();
                }), c.on("mousedown", function (e) {
                    var n;
                    if (n = t(e.target)) x(n) ? (e.preventDefault(), G(A(n))) : (J(), r(e.clientX, e.clientY, c.selection.getRng()) || c.selection.placeCaretAt(e.clientX, e.clientY)); else {
                        J(), re.hide();
                        var i = s.closestCaret(Z, e.clientX, e.clientY);
                    ...
                    var t = e.range;
                    if (oe) {
                        if (!oe.parentNode) return void (oe = null);
                        t = t.cloneRange(), t.selectNode(oe), e.range = t
                    }
                }), c.on("setSelectionRange", function (e) {
                    var t;
                    t = G(e.range), t && (e.range = t)
                }), c.on("focus", function () {
            ...
            function X() {
                ...
                e.push(re.getCss()), e.push(t + " .mce-offscreen-selection {position: absolute;left: -9999999999px;width: 100px;height: 100px;}" + t + " *[contentEditable=false] {cursor: default;}" + t + " *[contentEditable=true] {cursor: text;}")
            }
            ...
            var Z = c.getBody(), ee = new t(Z), te = b(v, ee.next), ne = b(v, ee.prev), re = new o(c.getBody(), y),
                ie = "sel-" + c.dom.uniqueId(), oe, ae = c.$;
            return e.ceFalse && (Y(), X()), {showBlockCaretContainer: W, destroy: Q}
        }

        var b = f.curry, C = l.isContentEditableTrue, x = l.isContentEditableFalse, w = l.isElement,
            N = i.isAfterContentEditableFalse, E = i.isBeforeContentEditableFalse, _ = c.getSelectedNode;
        return y
    }), r(Ge, [w, g, E, R, A, H, P, Y, J, Q, Z, ee, re, ie, N, f, Te, Me, B, M, Pe, d, m, u, He, Oe, Ie, Ue, Ke], function (e, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, C, x, w, N, E, _, S, k, T, R) {
        function A(e, t, i) {
            var o = this, a, s, l;
            a = o.documentBaseUrl = i.documentBaseURL, s = i.baseURI, l = i.defaultSettings, t = L({
                id: e,
                theme: "modern",
                delta_width: 0,
                delta_height: 0,
        ...
        var B = e.DOM, D = r.ThemeManager, M = r.PluginManager, L = N.extend, P = N.each, H = N.explode, O = N.inArray,
            I = N.trim, F = N.resolve, z = g.Event, W = w.gecko, V = w.ie;
        return A.prototype = {
            render: function () {
                function e() {
                ...
                function t() {
                    ...
                    N.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), P(r.external_plugins, function (e, t) {
                        M.load(t, e), r.plugins += " " + t
                    }), P(r.plugins.split(/[ ,]/), function (e) {
                        if (e = I(e), e && !M.urls[e]) if ("-" == e.charAt(0)) {
                        ...
                        } else M.load(e, {prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js"})
                ...
                if (t.iframeHTML = n.doctype + "<html><head>", n.document_base_url != t.documentBaseUrl && (t.iframeHTML += '<base href="' + t.documentBaseURI.getURI() + '" />'), !w.caretAfter && n.ie7_compat && (t.iframeHTML += '<meta http-equiv="X-UA-Compatible" content="IE=7" />'), t.iframeHTML += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />', !/#$/.test(document.location.href)) for (p = 0; p < t.contentCSS.length; p++) {
                    ...
                    t.iframeHTML += '<link type="text/css" rel="stylesheet" href="' + N._addCacheSuffix(g) + '" />', t.loadedCSS[g] = !0
                }
                ...
                }), n.serializer = new a(r, n), n.selection = new l(n.dom, n.getWin(), n.serializer, n), n.formatter = new c(n), n.undoManager = new u(n), n.forceBlocks = new f(n), n.enterKey = new d(n), n._nodeChangeDispatcher = new i(n), n._selectionOverrides = new R(n), n.fire("PreInit"), r.browser_spellcheck || r.gecko_spellcheck || (h.body.spellcheck = !1, B.setAttrib(p, "spellcheck", "false")), n.quirks = new x(n), n.fire("PostRender"), r.directionality && (p.dir = r.directionality), r.nowrap && (p.style.whiteSpace = "nowrap"), r.protect && n.on("BeforeSetContent", function (e) {
                ...
                }), r.auto_focus && E.setEditorTimeout(n, function () {
                    var e;
                ...
                var n = this, r = n.selection, i = n.settings.content_editable, o, a, s = n.getDoc(), l = n.getBody(),
                    c;
                if (!e) {
                ...
                t && (e = L({content: e}, t)), this.execCommand("mceInsertContent", !1, e)
            }, isDirty: function () {
        ...
        function r(e) {
            ...
            function f(r) {
                ...
                f.on("init", function () {
                    ...
                    var n = e.activeEditor, r;
                    r = t.target, n && r.ownerDocument == document && (n.selection && r != n.getBody() && (n.selection.lastFocusBookmark = c(n.dom, n.lastRng)), r == document.body || d(r) || e.focusedEditor != n || (n.fire("blur", {focusedEditor: null}), e.focusedEditor = null))
    ...
    }), r(Ze, [Ge, g, w, ie, d, m, c, le, Je, Qe], function (e, t, n, r, i, o, a, s, l, c) {
        function u(e) {
        ...
        function h(e) {
            return e && !(e.getContainer() || e.getBody()).parentNode && (f(e), e.unbindAllNativeEvents(), e.destroy(!0), e.removed = !0, e = null), e
        }
        ...
        return C = {
            ...
            setup: function () {
                ...
                if (n = r.getDocumentBaseUrl(document.location), /^[^:]+:\/\/\/?[^\/]+\//.test(n) && (n = n.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(n) || (n += "/")), o = window.tinymce || window.tinyMCEPreInit) t = o.base || o.baseURL, i = o.suffix; else {
        ...
        var n = {
            send: function (e) {
                ...
                if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = e.async !== !1, e.data = e.data || "", n.fire("beforeInitialize", {settings: e}), i = new XMLHttpRequest) {
                    if (i.overrideMimeType && i.overrideMimeType(e.content_type), i.open(e.type || (e.data ? "POST" : "GET"), e.url, e.async),
                    e.crossDomain && (i.withCredentials = !0), e.content_type && i.setRequestHeader("Content-Type", e.content_type), e.requestheaders && t.each(e.requestheaders, function (e) {
    ...
    }),r(at, [w, f, N, E, m, d], function (e, t, n, r, i, o) {
        ...
        return e.extend({
            init: function (e) {
                ...
                var e = this, t = e._id, n = e.settings, r = e.classPrefix, i = e.state.get("value") || "", o, a,
                    s = "", l = "";
        ...
        return e.extend({
            init: function (e) {
                ...
                var e = this, t = e._id, n = e.classPrefix, r = e.state.get("text"),
                    i = e.settings.icon ? n + "ico " + n + "i-" + e.settings.icon : "",
                    o = e.settings.image ? " style=\"background-image: url('" + e.settings.image + "')\"" : "", a = "";
        ...
        return e.extend({
            Defaults: {classes: "widget colorpicker"}, init: function (e) {
                ...
                var t = this, n = t._id, r = t.classPrefix, i,
                    o = "#ff0000,#ff0080,#ff00ff,#8000ff,#0000ff,#0080ff,#00ffff,#00ff80,#00ff00,#80ff00,#ffff00,#ff8000,#ff0000",
    ...
    }),r(kt, [ge, Ae, _e, m, Ze, d], function (e, t, n, r, i, o) {
        function a(e) {
            function t(t, n) {
                return function () {
                    var r = this;
            ...
            u = i(), s({
                ...
                var n = "Andale Mono=andale mono,monospace;Arial=arial,helvetica,sans-serif;Arial Black=arial black,sans-serif;Book Antiqua=book antiqua,palatino,serif;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier,monospace;Georgia=georgia,palatino,serif;Helvetica=helvetica,arial,sans-serif;Impact=impact,sans-serif;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco,monospace;Times New Roman=times new roman,times,serif;Trebuchet MS=trebuchet ms,geneva,sans-serif;Verdana=verdana,geneva,sans-serif;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
                    i = [], o = r(e.settings.font_formats || n);
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, C, x, w, N, E = [], _ = [], S, k, T, R, A,
                    B;
                ...
                if (w += g.left + g.right, N += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = N + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    var M = 0, L = t.flexWidths;
                    if (L) for (d = 0; d < L.length; d++) M += L[d]; else M = r;
                    var P = T / M;
                    for (d = 0; r > d; d++) E[d] += L ? L[d] * P : P;
                    for (p = g.top, f = 0; n > f; f++) {
                        for (h = g.left, s = _[f] + D, d = 0; r > d && (B = A ? f * r + r - 1 - d : f * r + d, u = i[B], u); d++) m = u.settings, c = u.layoutRect(), a = Math.max(E[d], c.startMinWidth), c.x = h, c.y = p, v = m.alignH || (C ? C[d] || C[0] : null), "center" == v ? c.x = h + a / 2 - c.w / 2 : "right" == v ? c.x = h + a - c.w : "stretch" == v && (c.w = a), v = m.alignV || (x ? x[d] || x[0] : null), "center" == v ? c.y = p + s / 2 - c.h / 2 : "bottom" == v ? c.y = p + s - c.h : "stretch" == v && (c.h = s), u.layoutRect(c), h += a + y, u.recalc && u.recalc();
                        p += s + b
                    }
        ...
        return i
    }),r(Pt, [Ae, ve, d, u], function (e, t, n, r) {
        return e.extend({
            Defaults: {border: 0, role: "menuitem"}, init: function (e) {
                ...
                var t = this, r = t._id, i = t.settings, o = t.classPrefix, a = t.encode(t.state.get("text")),
                    s = t.settings.icon, l = "", c = i.shortcut;
        ...
        return e.extend({
            init: function (e) {
                ...
                function o(t, n) {
                    function o(o) {
                        var a;
                        a = s.value(), a = i(t, n, e(t, n, a) + .05 * o), a = r(a, t, n), s.value(a), s.fire("dragstart", {value: a}), s.fire("drag", {value: a}), s.fire("dragend", {value: a})
                    }
                ...
                function a(e, i, o) {
                    ...
                    s._dragHelper = new t(s._id, {
                        handle: s._id + "-handle", start: function (e) {
                            a = e[u], l = parseInt(s.getEl("handle").style[d], 10), c = (s.layoutRect()[h] || 100) - n.getSize(o)[f], s.fire("dragstart", {value: m})
                        }, drag: function (t) {
                            var n = t[u] - a;
                            p = r(l + n, 0, c), o.style[d] = p + "px", m = e + p / c * (i - e), s.value(m), s.tooltip().text("" + s.settings.previewFilter(m)).show().moveRel(o, "bc tc"), s.fire("drag", {value: m})
                        }, stop: function () {
                            s.tooltip().hide(), s.fire("dragend", {value: m})
                        }
                    })
                }

                var s = this, l, c, u, d, f, h;
    ...
    }),a([l, c, u, d, f, h, m, g, v, y, C, w, N, E, T, A, B, D, M, L, P, H, I, F, j, Y, J, Q, re, ie, oe, ae, le, ue, de, me, ge, ve, ye, be, Ce, xe, we, Ne, Ee, _e, Se, ke, Te, Re, Ae, Be, De, Me, He, Ie, Ge, Je, Qe, Ze, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, ht, pt, mt, gt, vt, yt, bt, Ct, xt, wt, Nt, Et, _t, St, kt, Tt, Rt, At, Bt, Dt, Mt, Lt, Pt, Ht, Ot, It, Ft, zt, Wt, Vt, Ut, $t, qt, jt, Yt])
}(this);